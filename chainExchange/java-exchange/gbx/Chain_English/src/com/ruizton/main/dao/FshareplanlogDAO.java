...
public class FshareplanlogDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(FshareplanlogDAO.class);
	// property constants
	...
	public Fshareplanlog findById(java.lang.Integer id) {
		...
		try {
			Fshareplanlog instance = (Fshareplanlog) getSession().get(
					"com.ruizton.main.model.Fshareplanlog", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fshareplanlog> findByExample(Fshareplanlog instance) {
		...
		try {
			List<Fshareplanlog> results = (List<Fshareplanlog>) getSession()
					.createCriteria("com.ruizton.main.model.Fshareplanlog").add(create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fshareplanlog instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Fshareplanlog as model where model."
					+ propertyName + "= ?";
	...
	public Fshareplanlog merge(Fshareplanlog detachedInstance) {
		...
		try {
			Fshareplanlog result = (Fshareplanlog) getSession().merge(
					detachedInstance);
