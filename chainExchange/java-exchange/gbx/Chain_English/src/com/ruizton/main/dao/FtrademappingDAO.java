 ...
 * 
 * @see com.ruizton.main.model.Ftrademapping
...
public class FtrademappingDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(FtrademappingDAO.class);
	// property constants
	...
	public Ftrademapping findById(java.lang.Integer id) {
		...
		try {
			Ftrademapping instance = (Ftrademapping) getSession().get(
					"com.ruizton.main.model.Ftrademapping", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Ftrademapping> findByExample(Ftrademapping instance) {
		...
		try {
			List<Ftrademapping> results = (List<Ftrademapping>) getSession()
					.createCriteria("com.ruizton.main.model.Ftrademapping").add(create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Ftrademapping instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Ftrademapping as model where model."
					+ propertyName + "= ?";
	...
	public List<Ftrademapping> findByFisshowKlineNottrade(
			Object fisshowKlineNottrade) {
	...
	public Ftrademapping merge(Ftrademapping detachedInstance) {
		...
		try {
			Ftrademapping result = (Ftrademapping) getSession().merge(
					detachedInstance);
