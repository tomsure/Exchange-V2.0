...
public class FbalancelogDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(FbalancelogDAO.class);
	// property constants
	...
	public Fbalancelog findById(java.lang.Integer id) {
		...
		try {
			Fbalancelog instance = (Fbalancelog) getSession().get(
					"com.ruizton.main.model.Fbalancelog", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fbalancelog> findByExample(Fbalancelog instance) {
		...
		try {
			List<Fbalancelog> results = (List<Fbalancelog>) getSession()
					.createCriteria("com.ruizton.main.model.Fbalancelog").add(create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fbalancelog instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fbalancelog as model where model."
					+ propertyName + "= ?";
	...
	public Fbalancelog merge(Fbalancelog detachedInstance) {
		...
		try {
			Fbalancelog result = (Fbalancelog) getSession().merge(
					detachedInstance);
