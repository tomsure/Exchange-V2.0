...
public class FgoodscommDAO extends HibernateDaoSupport {
	...
	public Fgoodscomm findById(java.lang.Integer id) {
		...
		try {
			Fgoodscomm instance = (Fgoodscomm) getSession().get(
					"com.ruizton.main.model.Fgoodscomm", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fgoodscomm> findByExample(Fgoodscomm instance) {
		...
		try {
			List<Fgoodscomm> results = (List<Fgoodscomm>) getSession()
					.createCriteria("com.ruizton.main.model.Fgoodscomm")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fgoodscomm instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fgoodscomm as model where model."
					+ propertyName + "= ?";
	...
	public Fgoodscomm merge(Fgoodscomm detachedInstance) {
		...
		try {
			Fgoodscomm result = (Fgoodscomm) getSession().merge(
					detachedInstance);
