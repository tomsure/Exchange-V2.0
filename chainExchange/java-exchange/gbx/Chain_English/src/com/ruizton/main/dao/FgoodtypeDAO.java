...
public class FgoodtypeDAO extends HibernateDaoSupport {
	...
	public Fgoodtype findById(java.lang.Integer id) {
		...
		try {
			Fgoodtype instance = (Fgoodtype) getSession().get(
					"com.ruizton.main.model.Fgoodtype", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fgoodtype> findByExample(Fgoodtype instance) {
		...
		try {
			List<Fgoodtype> results = (List<Fgoodtype>) getSession()
					.createCriteria("com.ruizton.main.model.Fgoodtype")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fgoodtype instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fgoodtype as model where model."
					+ propertyName + "= ?";
