...
import com.ruizton.main.model.Fgoodsaddress;

/**
 	* A data access object (DAO) providing persistence and search support for Fgoodsaddress entities.
...
public class FgoodsaddressDAO extends HibernateDaoSupport  {
    ...
    public Fgoodsaddress findById( java.lang.Integer id) {
        ...
        try {
            Fgoodsaddress instance = (Fgoodsaddress) getSession()
                    .get("com.ruizton.main.model.Fgoodsaddress", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Fgoodsaddress> findByExample(Fgoodsaddress instance) {
        ...
        try {
            List<Fgoodsaddress> results = (List<Fgoodsaddress>) getSession()
                    .createCriteria("com.ruizton.main.model.Fgoodsaddress")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Fgoodsaddress instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Fgoodsaddress as model where model." 
         						+ propertyName + "= ?";
    ...
    public Fgoodsaddress merge(Fgoodsaddress detachedInstance) {
        ...
        try {
            Fgoodsaddress result = (Fgoodsaddress) getSession()
	...
	public List<Fgoodsaddress> list(int firstResult, int maxResults,
