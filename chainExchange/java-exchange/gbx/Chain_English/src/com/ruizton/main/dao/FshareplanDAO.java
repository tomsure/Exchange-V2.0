...
public class FshareplanDAO extends HibernateDaoSupport {
	...
	public Fshareplan findById(java.lang.Integer id) {
		...
		try {
			Fshareplan instance = (Fshareplan) getSession().get("com.ruizton.main.model.Fshareplan",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fshareplan> findByExample(Fshareplan instance) {
		...
		try {
			List<Fshareplan> results = (List<Fshareplan>) getSession()
					.createCriteria("com.ruizton.main.model.Fshareplan").add(create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fshareplan instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fshareplan as model where model."
					+ propertyName + "= ?";
	...
	public Fshareplan merge(Fshareplan detachedInstance) {
		...
		try {
			Fshareplan result = (Fshareplan) getSession().merge(
					detachedInstance);
