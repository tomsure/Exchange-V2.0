...
public class FbankinDAO extends HibernateDaoSupport {
	...
	public Fbankin findById(java.lang.Integer id) {
		...
		try {
			Fbankin instance = (Fbankin) getSession().get("com.ruizton.main.model.Fbankin", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fbankin> findByExample(Fbankin instance) {
		...
		try {
			List<Fbankin> results = (List<Fbankin>) getSession()
					.createCriteria("com.ruizton.main.model.Fbankin").add(create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fbankin instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fbankin as model where model."
					+ propertyName + "= ?";
