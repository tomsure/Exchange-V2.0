...
public class FgoodsDAO extends HibernateDaoSupport {
	...
	public Fgoods findById(java.lang.Integer id) {
		...
		try {
			Fgoods instance = (Fgoods) getSession().get(
					"com.ruizton.main.model.Fgoods", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fgoods> findByExample(Fgoods instance) {
		...
		try {
			List<Fgoods> results = (List<Fgoods>) getSession()
					.createCriteria("com.ruizton.main.model.Fgoods")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fgoods instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fgoods as model where model."
					+ propertyName + "= ?";
