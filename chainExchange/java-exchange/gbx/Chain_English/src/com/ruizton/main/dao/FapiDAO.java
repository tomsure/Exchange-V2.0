...
/**
 	* A data access object (DAO) providing persistence and search support for Fapi entities.
...
public class FapiDAO extends HibernateDaoSupport  {
    ...
    public Fapi findById( java.lang.Integer id) {
        ...
        try {
            Fapi instance = (Fapi) getSession()
                    .get("com.ruizton.main.model.Fapi", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Fapi> findByExample(Fapi instance) {
        ...
        try {
            List<Fapi> results = (List<Fapi>) getSession()
                    .createCriteria("com.ruizton.main.model.Fapi")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Fapi instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Fapi as model where model." 
         						+ propertyName + "= ?";
