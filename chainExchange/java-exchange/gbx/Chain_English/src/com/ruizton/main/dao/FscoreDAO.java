...
/**
 	* A data access object (DAO) providing persistence and search support for Fscore entities.
...
public class FscoreDAO extends HibernateDaoSupport  {
    ...
    public Fscore findById( java.lang.Integer id) {
        ...
        try {
            Fscore instance = (Fscore) getSession()
                    .get("com.ruizton.main.model.Fscore", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Fscore> findByExample(Fscore instance) {
        ...
        try {
            List<Fscore> results = (List<Fscore>) getSession()
                    .createCriteria("com.ruizton.main.model.Fscore")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Fscore instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Fscore as model where model." 
         						+ propertyName + "= ?";
    ...
    public Fscore merge(Fscore detachedInstance) {
        ...
        try {
            Fscore result = (Fscore) getSession()
