 ...
 * 
 * @see com.ruizton.main.model.Ftransportlog
...
public class FtransportlogDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(FtransportlogDAO.class);
	// property constants
	...
	public Ftransportlog findById(java.lang.Integer id) {
		...
		try {
			Ftransportlog instance = (Ftransportlog) getSession().get(
					"com.ruizton.main.model.Ftransportlog", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Ftransportlog> findByExample(Ftransportlog instance) {
		...
		try {
			List<Ftransportlog> results = (List<Ftransportlog>) getSession()
					.createCriteria("com.ruizton.main.model.Ftransportlog")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Ftransportlog instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Ftransportlog as model where model."
					+ propertyName + "= ?";
	...
	public Ftransportlog merge(Ftransportlog detachedInstance) {
		...
		try {
			Ftransportlog result = (Ftransportlog) getSession().merge(
					detachedInstance);
