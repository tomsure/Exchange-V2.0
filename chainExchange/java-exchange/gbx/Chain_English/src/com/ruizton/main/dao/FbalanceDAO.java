...
public class FbalanceDAO extends HibernateDaoSupport {
	...
	public Fbalance findById(java.lang.Integer id) {
		...
		try {
			Fbalance instance = (Fbalance) getSession().get(
					"com.ruizton.main.model.Fbalance", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fbalance> findByExample(Fbalance instance) {
		...
		try {
			List<Fbalance> results = (List<Fbalance>) getSession()
					.createCriteria("com.ruizton.main.model.Fbalance")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fbalance instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fbalance as model where model."
					+ propertyName + "= ?";
