				...
				<div class="col-xs-8 col-xs-offset-2 reset-body">
					<div class="col-xs-12">
						<span class="reset-title">
							...
							<div class="col-xs-10 form-horizontal padding-top-30" id="secondstep">
								<div class="form-group ">
									<label class="col-xs-4 control-label" for="reset-loginname">Email</label>
									<div class="col-xs-8">
							...
							<div style="display:none" class="col-xs-12 padding-top-30 successstep text-center" id="successstep">
								<div>
									...
									Congratulations, resetting the password success
								</div>
								<a class="btn btn-danger btn-find" href="/user/login.html">Log in immediately</a>
							</div>
