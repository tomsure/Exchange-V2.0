                            ...
                            <div class="kyc_01" style="display: block;">
                                <div class="title">
                                    ...
                                    <c:if test="${fuser.fpostRealValidate && fuser.fhasRealValidate}">
                                        <span class="s2" style="display:none">(Authenticated)</span>
                                    </c:if>
                                    <c:if test="${!fuser.fpostRealValidate || !fuser.fhasRealValidate}">
                                        <span class="s2" style="display:none;">(Not Authenticated)</span>
                                    </c:if>
                                </div>
                                <div class="user_set">    
                                   
                                <div id="leadid" class="lead" >                                                      
                                    <p style="font-size: 12.5px">Passport Number /ID Number ( Driver's License number if you are United States national or National ID number if you are a resident of European countries)</p>
                                 </div>                                                    
                                    <div class="nav_btn">
                                        <div class="id_card all_card">
                                            ...
                                            <p class="p2">
                                                <c:if test="${fuser.fpostRealValidate && !fuser.fhasRealValidate}">
                                                   <span class="step1-btn disabled">Audit</span>
                                                </c:if>
                                                <c:if test="${fuser.fpostRealValidate && fuser.fhasRealValidate}">
                            ...
                            <div class="kyc_02" style="display: ${requestScope.constant['isHideKYC'] ==1?'none;':'block;'}">
                                ...
                                <div class="step_01">
                                    ...
                                    <div class="up_img_01 all_up">
                                        <p class="left">The front copy Passport / ID Card(you can choose to upload the front copy of your Driver's License if you are United States national or National ID document if you are a resident of European countries)</p>
                                        <br/>
                                        <div class="user_up">
                                            <div class="work_info">
                                                <c:choose>
                                    ...
                                    <div class="up_img_02 all_up">
                                        <p class="left">Scan copy of your proof of address that is issued within the last 3 months. ( eg. Bank statement, utility bill, phone bill etc..)</p>
                                        <br/>
                                        <div class="user_up">
                                            <div class="work_info">
                                                <c:choose>
                                            ...
                                            <div class="imgs">
                                                <div class="pic2show">
                                                 <c:if test="${fuser.fpostImgValidate && fuser.fIdentityPath2 != ''}">
                                    ...
                                    <div class="up_img_03 all_up">
                                        <p class="left">Handheld photo of Passport/Identity Card/Overseas Resident Card</p>
                                        <br/>
                                        <div class="user_up">
                                            <div class="work_info">
                                             <c:choose>
                                            ...
                                            <div class="imgs">
                                                <div class="pic3show">
                                                  <c:if test="${fuser.fpostImgValidate && fuser.fIdentityPath3 != ''}">
				...
				<div class="modal-body form-horizontal">
					<div class="form-group ">
						...
						<div class="col-xs-6">
							...
							<span id="bindrealinfo-realname-errortips " class="text-danger certificationinfocolor" style="display: none">
