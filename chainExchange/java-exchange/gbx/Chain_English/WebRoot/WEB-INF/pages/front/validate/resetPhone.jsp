						...
						<span class="reset-title">
							...
							<div class="col-xs-10 form-horizontal padding-top-30">
								<div class="form-group " style="display: none">
									<label for="reset-areaCode" class="col-xs-4 control-label">Location</label>
									<div class="col-xs-8">
								...
								<div class="form-group ">
									<label for="reset-phone" class="col-xs-4 control-label">Phone</label>
									<div class="col-xs-8">
										<span id="reset-phone-areacode" class="btn btn-areacode" style="display: none">+86</span>
										<input id="reset-phone" class="form-control padding-left-92" type="text">Add '+' to the front except chinese mobile.
									</div>
								</div>
								<div class="form-group ">
								...
								<div class="form-group ">
									<label for="reset-msgcode" class="col-xs-4 control-label">SMS Verification Code</label>
									<div class="col-xs-8">
										<input id="reset-msgcode" class="form-control" type="text">
										<button id="reset-sendmessage" data-msgtype="9" data-tipsid="reset-errortips" class="btn btn-sendmsg">Send</button>
									</div>
								</div>
								<div class="form-group " style="display: none">
								...
								<div class="form-group " style="display: none">
									<label for="reset-idcardno" class="col-xs-4 control-label">Number</label>
									<div class="col-xs-8">
								...
								<div class="form-group ">
									...
									<div class="col-xs-8">
										<button id="btn-next" class="btn btn-danger btn-block">Next</button>
									</div>
								</div>
							</div>
