					...
					<div class="user-pwd-recovevery-block">
						<form action="/" class="form-horizontal user-registrations text-center">
							<div class="controls">
								...
								<h3 class="h3-tab">
									<span>Mobile</span>
									<a href="/user/register.html">Email</a>
								</h3>
							</div>
							<div class="form-controls">
								<div class="control-group ">
									<div class="controls">
										<input type="text" id="register-phone" placeholder="e.g: +91 Phone No" /></div>
								</div>
								<div class="control-group ">
									<div class="controls">
								...
								<div class="control-group ">
									<div class="controls">
										...
										<a class="controls-right btn-sendmsg" data-msgtype="12" data-tipsid="register-errortips" id="register-sendmessage">Send</a>
									</div>
								</div>
								<div>
									<div class="control-group ">
