		...
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/answerQuestion.html">
				<li><a class="edit"
					...
					height="300" width="800" target="dialog" rel="updateLink"><span>Reply</span>
				</a></li>
			</shiro:hasPermission>
		</ul>
	</div>
		...
		<thead>
			<tr>
				...
				<th width="60" orderField="fSolveTime"
					<c:if test='${param.orderField == "fSolveTime"}'> class="${param.orderDirection}"  </c:if>>Reply Time</th>
			</tr>
		</thead>
		<tbody>
