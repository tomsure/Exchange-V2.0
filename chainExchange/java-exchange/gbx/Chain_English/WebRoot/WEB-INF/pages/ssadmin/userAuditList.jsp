		...
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/auditUser1.html">
				<li><a class="edit"
					...
					target="dialog" rel=auditUser height="400" width="800"><span>Approve</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/auditUser2.html">	
			<li><a title="Confirm: Are you sure you approve all?" target="selectedTodo" rel="ids"
			...
			<li><a title="Confirm: Are you sure you reject all?" target="selectedTodo" rel="ids"
				postType="string" href="ssadmin/auditUserALL.html?type=2"
				class="edit"><span>Reject All</span> </a>
			</li>
			</shiro:hasPermission>
		</ul>
	</div>
