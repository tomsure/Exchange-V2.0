		...
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/capitalInAudit.html">
				<li><a class="edit"
					   ...
					   title="Confirm: Are you sure you want to approve?"><span>Approve</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/capitalInCancel.html">
				<li><a class="edit"
					   href="ssadmin/capitalInCancel.html?uid={sid_user}"
					   target="ajaxTodo" title="Confirm: Are you sure you want to cancel the deposit?"><span>Cancel Deposit</span> </a>
				</li>
			</shiro:hasPermission>
	...
	<table class="table" width="120%" layoutH="138">
		...
		<tr>
			...
			<th width="60" orderField="fremittanceType"
					<c:if test='${param.orderField == "fremittanceType" }'> class="${param.orderDirection}"  </c:if>>Type</th>
	...
	<div class="panelBar">
		<div class="pages">
			...
			<c:forEach items="${amountInMap }" var="v">
				<font color="red">Today Total amount of recharge：$<fmt:formatNumber value="${v.value}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="4"/>;</font>
			</c:forEach>
			</span>
		</div>
