...
<h2 class="contentTitle">Modify a permission. Previous menu: <font color="red">${security.fname}</font></h2>
		...
		<div class="pageFormContent nowrap" layoutH="97">
			<dl>
				...
				<input type="hidden" name="fid" value="${oldSecurity.fid }"/>
					<input type="text" name="fname" maxlength="255" class="required" size="70" value="${oldSecurity.fname }"/>
				</dd>
			</dl>
			<dl>
